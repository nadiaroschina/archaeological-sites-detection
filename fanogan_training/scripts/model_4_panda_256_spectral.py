...
class PandaDiscriminator(nn.Module):
    ...
    def __init__(self, opt):
        ...
        self.res_blocks = nn.Sequential(
            ...
            ResBlk(64, 128, downsample=True, normalize=True, spectral=True),
            ResBlk(128, 256, downsample=True, normalize=True, spectral=True),
            ResBlk(256, 512, downsample=False, normalize=True, spectral=True)
        )
        self.fc = SpectralNorm(nn.Linear(512 * (self.img_size // 64) * (self.img_size // 64), 1))
