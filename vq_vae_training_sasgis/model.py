...
class VQVAE(nn.Module):
    ...
    def __init__(self, in_channels, embedding_dim, num_embeddings, hidden_dims=None, beta=0.25, img_size=64, **kwargs):
        ...
        modules.append(nn.Sequential(
                nn.ConvTranspose2d(hidden_dims[-1], out_channels=self.init_channels, kernel_size=4, stride=2, padding=1),
                nn.Tanh()
        ))
    ...
    def sample(self, num_samples, current_device, **kwargs):
        raise NotImplementedError('VQVAE sampler is not implemented.')
